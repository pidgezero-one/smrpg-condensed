...
script = AnimationScriptBlock(expected_size=30, expected_beginning=0x3A82AA, script=[
	ResetTargetMappingMemory(identifier="command_0x3A82AA"),
	SetAMEM40ToXYZCoords(origin=ABSOLUTE_POSITION, x=184, y=152, z=0, set_x=True, set_y=True, set_z=True),
	ReturnSubroutine(),
	ResetTargetMappingMemory(identifier="command_0x3A82B4"),
	SetAMEM40ToXYZCoords(origin=ABSOLUTE_POSITION, x=200, y=160, z=0, set_x=True, set_y=True, set_z=True),
	ReturnSubroutine(),
	ResetTargetMappingMemory(identifier="command_0x3A82BE"),
